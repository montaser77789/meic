...
import { Equipment as EquipmentType } from "@prisma/client";
import { UpdateEquipment } from "../_action/equipment";
...
const EditEquipment = ({
  ...
  const [selectedImage, setSelectedImage] = useState(Equipment.image ?? "");
  console.log(Equipment.publicId);
  ...
  useEffect(() => {
    setSelectedImage(Equipment.image as string);
  }, [Equipment.image]);
